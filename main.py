...
#     while True:
#         if jumlah_data_aktual < 500: #butuh 500 data untuk menjalankan fungsi pelatihan model (jika model belum ada)
...
#     while True:
#         if jumlah_data_aktual < 24 + n_input: #butuh min 28 data untuk menjalankan program
